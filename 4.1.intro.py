...
if __name__ == "__main__":
    ...
    # print(y.shape)
    # print('y = \n', y)
    # plt.figure(facecolor='w') #边框背景白色
    # plt.plot(x, y, 'ro-', linewidth=2,markeredgecolor='k')  #红色圆圈
    # #plt.plot(x, y, 'r-', x, y, 'go', linewidth=2, markersize=8)
    # plt.xlabel('X', fontsize=15)
    # plt.ylabel('Y', fontsize=15)
    # plt.title(u'高斯分布函数', fontsize=18,color = "k")
    # # plt.grid(True, which='major',linestyle='--',color = "k",linewidth=2)
    # plt.grid(True, which='major', linestyle=':', color="k", linewidth=2)
    # plt.show()
    ...
    # print('x\n',x,len(x))
    # print('t\n',t,len(t))
    # plt.hist(x, 50, color='m', alpha=0.5, label=u'均匀分布')
    ...
    # a = np.zeros(10000)
    # for i in range(t):
    #     b=np.random.uniform(-5, 5, 10000)  #均匀分布
    #     a += b
    # print(a)
    # a /= t
    # print(a)
    ...
    # ax.plot_surface(x, y, z, rstride=3, cstride=3, cmap=cm.gist_heat, linewidth=0.5,linestyle='--')
    # plt.show()
